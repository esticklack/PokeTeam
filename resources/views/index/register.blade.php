        ...
        <form id="form-registro">
          ...
          <div class="form-group">
            ...
            <div id="password_invalida_caracteres" class="form-text" style="display: none;">
                <span class="badge text-bg-danger">La contraseña debe contener al menos 8 caracteres.</span>
            </div>
            <div id="password_invalida_letras" class="form-text" style="display: none;">
                <span class="badge text-bg-danger">La contraseña debe tener al menos una letra.</span>
            </div>
            <div id="password_invalida_numeros" class="form-text" style="display: none;">
                <span class="badge text-bg-danger">La contraseña debe tener al menos un número.</span>
            </div>
          </div>
          <div class="form-group">
